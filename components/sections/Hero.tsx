...
import { Suspense, useMemo } from "react";   // ← Changed: removed useState + useEffect
...
export function Hero() {
  ...
  // Best solution: Calculate splashDelay once during render
  const splashDelay = useMemo(() => {
        ...
        <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start z-10">
            <motion.div
                ...
                transition={{ duration: 0.8, delay: splashDelay ? 3.2 : 0.1 }}
            >
